...
from jasna.models.basicvsrpp.deformconv import ModulatedDeformConv2d, deform_conv2d_dispatch
...
class SecondOrderDeformableAlignment(ModulatedDeformConv2d):
    ...
    def forward(self, x, extra_feat, flow_1, flow_2):
        ...
        # Dispatches to torchvision's kernel on cuda/rocm/cpu and a grid_sample
        # composition on xpu (torchvision ships no XPU deform_conv2d kernel).
        return deform_conv2d_dispatch(x, offset, self.weight, self.bias,
                                      self.stride, self.padding,
                                      self.dilation, mask, self.groups)
